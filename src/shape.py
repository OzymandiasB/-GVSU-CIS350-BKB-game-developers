...
class Shape:
    shapes = [
        ...
        [[1, 2, 3, 5, 7], [1, 2, 6, 9, 10]],  # Custom C shape
        [[3,5,7,9,10,11],[0,4,6,8,9,10],[0,1,2,4,6,8],[1,2,3,5,7,11],[5,6,10,12,13,14], [5,6,9,13,14,15],[0,1,2,6,10,9],[1,2,3,5,9,10]]   # custom J shape
